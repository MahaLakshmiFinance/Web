...
<div class="templatemo-content-container">
    ...
    <div class="templatemo-content-widget white-bg">
        ...
        </div><form action="php/content/content1/delete_user.php" name="delete_user" style="display:none;"class="templatemo-login-form" method="POST" enctype="multipart/form-data">
